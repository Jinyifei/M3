...
c
      theversion='v5.1.13'
c
      call mpi_init(taskerr)
      call mpi_comm_rank(MPI_COMM_WORLD, taskid, taskerr)
      call mpi_comm_size(MPI_COMM_WORLD, numtasks, taskerr)
c
      write (*,*) 'taskid=', taskid
